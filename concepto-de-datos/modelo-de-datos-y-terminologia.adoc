...
Símbolo Significado Ejemplos de presentación
G era era era
C siglo de era (> = 0) número 20
Y año de era (> = 0) año 1996
x semana año año 1996
semana de la semana año número 27
El día de la semana número 2
E texto del día de la semana martes; mar
año año 1996
D día del año número 189
M mes del año mes julio; Jul; 07
d día del mes número 10
un medio día de texto del día PM
K hora del medio día (0 ~ 11) número 0
h hora del medio día (1 ~ 12) número 12
H hora del día (0 ~ 23) número 0
k reloj hora del día (1 ~ 24) número 24
m minuto de la hora número 30
s segundo del minuto número 55
S fracción de segundo milis 978
z texto de la zona horaria Hora estándar del Pacífico; PST
Desplazamiento de zona horaria Z / zona de identificación -0800; -08: 00; America / Los_Angeles
'escape para delimitador de texto
'' literal de comillas simples '
Relativa de tiempo activa
La hora relativa se refiere a la hora relativa a la hora del servidor ahora () y la hora DATETIME.

Sintaxis:

  Duración = (Dígito + ('Y' | 'MO' | 'W' | 'D' | 'H' | 'M' | 'S' | 'MS' | 'US' | 'NS')) +
  RelativeTime = (ahora () | DATETIME) ((+ | -) Duración) +
       

** La sintaxis de la unidad de duración **
Símbolo Significado Ejemplos de presentación
año 1 año = 365 días 1 año
mes mes 1 mes = 30 días 1 mes
semana 1 semana = 7 días 1 semana
d día 1d = 1 día 1d
h hora 1h = 3600 segundos 1h
m minuto 1m = 60 segundos 1m
s segundo 1s = 1 segundo 1s
ms milisegundo 1 ms = 1000_000 nanosegundos 1 ms
us microsegundo 1us = 1000 nanosegundos 1us
ns nanosegundo 1ns = 1 nanosegundo 1ns
p.ej:

ahora () - 1d2h // 1 día y 2 horas antes que la hora actual del servidor
ahora () - 1 semana // 1 semana antes de la hora actual del servidor

Nota: Debe haber espacios a la izquierda y derecha de '+' y '-'.